...
public class UpdatePlatformsListUseCaseIntegrationTests {
    ...
    @Test()
    public void it_should_be_able_to_save_cores_given_list_of_platforms() throws Exception {
        sut.execute("./test-folder");
        assertEquals(1, repository.listAll().size());
    }

    @Test
    public void it_should_not_save_cores_given_folder_do_not_exists() {
