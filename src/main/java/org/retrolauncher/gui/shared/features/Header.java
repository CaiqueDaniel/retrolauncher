...
import org.retrolauncher.gui.shared.viewmodels.HeaderViewModel;
...
public class Header extends HBox {
    ...
    private void load() {
        try {
            FXMLLoader loader = new FXMLLoader(Main.class.getResource("shared/templates/features/Header.fxml"));
