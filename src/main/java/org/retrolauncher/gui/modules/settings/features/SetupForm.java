...
import org.retrolauncher.gui.modules.settings.viewmodel.SetupViewModel;
import org.retrolauncher.gui.modules.settings.models.Setting;
import org.retrolauncher.gui.shared.components.DirectoryField;
...
public class SetupForm extends VBox {
    ...
    private void load() {
        try {
            FXMLLoader loader = new FXMLLoader(Main.class.getResource("modules/settings/templates/features/SetupForm.fxml"));
