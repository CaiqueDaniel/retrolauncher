...
import org.retrolauncher.gui.modules.games.viewmodels.CoverViewViewModel;
...
public class CoverView extends AnchorPane {
    ...
    private void load() {
        try {
            FXMLLoader loader = new FXMLLoader(Main.class.getResource("modules/games/templates/features/CoverView.fxml"));
